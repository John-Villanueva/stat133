...
# < your code here>
mtcars2 <- cbind(mtcars,rownames(mtcars))
colnames(mtcars2)[12] <- c("model")
...
optionlist <- list(title="Car Models",
                   hAxes="[{title: 'Engine Displacement'}]",vAxes="[{title: 'Miles per Gallon'}]")
bub <- gvisBubbleChart(mtcars2,idvar="model",xvar="disp",yvar="mpg",sizevar="hp",
...
Motion <- gvisMotionChart(WorldDat,idvar="country",timevar="year",colorvar="region",sizevar="population",
